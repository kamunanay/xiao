...
function getPhoneNumber() {
    return new Promise((resolve) => {
        rl.question('📱 Masukkan nomor WhatsApp untuk dijadikan sender bot (contoh: 6281234567890): ', (number) => {
            // Clean the number
            ...
            if (cleanNumber.startsWith('62') && cleanNumber.length >= 10 && cleanNumber.length <= 15) {
                ...
                console.log('❌ Format nomor tidak valid! Harus diawali 62 (contoh: 6281234567890)');
...
async function startBot() {
    try {
        console.log('\n🚀 Starting XIS CORE SYSTEMS...\n');
        
        // Get phone number from user
        const phoneNumber = await getPhoneNumber();
        
        console.log(`\n📱 Menggunakan nomor: ${phoneNumber}`);
        console.log('🔄 Memulai proses pairing...\n');
